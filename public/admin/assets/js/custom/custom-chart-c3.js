...
$(document).ready(function() {
    ...
    var scatterPlotChart = c3.generate({
        ...
        color: { pattern: ["#f4f5f7", "#9ccc34", "#EE1825"] },
        data: {
            xs: {
                setosa: 'setosa_x',
    ...
    var stackedBarChart = c3.generate({
        ...
        color: { pattern: ["#f4f5f7", "#EE1825", "#9ccc34"] },
        data: {
            columns: [
    ...
    var combinationChart = c3.generate({
        ...
        color: { pattern: ["#EE1825", "#f4f5f7", "#f62525", "#25bef6", "#9ccc34", "#fcbc04"] },
        data: {
            columns: [
    ...
    var gaugeChart = c3.generate({
        ...
        color: {
            pattern: ['#9ccc34', '#f62525', '#fcbc04', '#EE1825'],
            threshold: {
                values: [30, 60, 90, 100]
            }
        },
    ...
    var pieChart = c3.generate({
        bindto: '#c3-pie',
        color: { pattern: ["#EE1825", "#f4f5f7", "#9ccc34"] },
        data: {
            columns: [
                ['SeriesA', 40],
                ['SeriesB', 25],
