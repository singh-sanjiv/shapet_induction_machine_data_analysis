        ...
        var lineChart = new Chart(linechartID, {
            ...
            data: {
                ...
                datasets: [{
                    ...
                    backgroundColor: ["#EE1825"],
                    borderColor: ["#EE1825"],
                    pointBorderColor: ["#EE1825","#EE1825","#EE1825","#EE1825","#EE1825","#EE1825","#EE1825"],
        ...
        var scatterChart = new Chart(scatterChartID, {
            ...
            data: {
                datasets: [{
                    ...
                    pointBorderColor: ["#EE1825","#EE1825","#EE1825","#EE1825","#EE1825","#EE1825","#EE1825","#EE1825","#EE1825","#EE1825","#EE1825"],
        ...
        var barChart = new Chart(barChartID, {
            type: 'bar',
                data: {
                    ...
                    datasets: [{
                        label: 'Series A',
                        backgroundColor: ["#EE1825", "#EE1825", "#EE1825", "#EE1825", "#EE1825", "#EE1825", "#EE1825"],
                        borderColor: ["#EE1825", "#EE1825", "#EE1825", "#EE1825", "#EE1825", "#EE1825", "#EE1825"],
                        borderWidth: 1,
        ...
        var multiAxisBarChart = new Chart(multiAxisBarChartID, {
            type: 'bar',
                data: {
                    ...
                    datasets: [{
                        label: 'Series A',
                        backgroundColor: ["#EE1825","#9ccc34","#f4f5f7","#f62525","#fcbc04","#25bef6","#151d2e"],
                        yAxisID: 'y-axis-1',
        ...
        var datasetArea = new Chart(datasetAreaID, {
            ...
            data: {
                ...
                datasets: [{
                    ...
                    backgroundColor: ["rgba(4,66,186,0.5)"],
                    borderColor: ["#EE1825"],
                    pointBorderColor: ["#EE1825","#EE1825","#EE1825","#EE1825","#EE1825","#EE1825","#EE1825","#EE1825"],
                    pointBackgroundColor: ["#ffffff","#ffffff","#ffffff","#ffffff","#ffffff","#ffffff","#ffffff","#ffffff"],
                    pointBorderWidth: 2,                                               
        ...
        var radarArea = new Chart(radarAreaID, {
            ...
            data: {
                ...
                datasets: [{
                    ...
                    borderColor: ["#EE1825"],
                    pointBorderColor: ["#ffffff","#ffffff","#ffffff","#ffffff","#ffffff","#ffffff","#ffffff","#ffffff"],
                    pointBackgroundColor: ["#EE1825","#EE1825","#EE1825","#EE1825","#EE1825","#EE1825","#EE1825","#EE1825"],
                    pointBorderWidth: 1,
        ...
        var doughnutChart = new Chart(doughnutChartID, {
            ...
            data: {
                datasets: [{
                    ...
                    backgroundColor: ["#EE1825","#9ccc34","#f4f5f7"],
                    label: 'Dataset 1'
                }],
