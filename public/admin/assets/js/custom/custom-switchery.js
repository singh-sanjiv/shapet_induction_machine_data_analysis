...
!function($) {
  "use strict";
      ...
      var switchery = new Switchery(primary, { color: '#EE1825' });
      ...
      var switchery = new Switchery(primary_small, { color: '#EE1825', size: 'small' });
      ...
      var switchery = new Switchery(primary_large, { color: '#EE1825', size: 'large' });
      ...
      var switchery = new Switchery(primary_multicolor, { color: '#EE1825', jackColor: '#dbe5fd' });
      ...
      var switchery = new Switchery(primary_multicolor_on_off, { color: '#EE1825', secondaryColor: '#949ca9', jackColor: '#dbe5fd', jackSecondaryColor: '#e9eaed' });
      var secondary_multicolor_on_off = document.querySelector('.js-switch-secondary-multicolor-on-off');
      var switchery = new Switchery(secondary_multicolor_on_off, { color: '#acacb4', secondaryColor: '#EE1825', jackColor: '#e9eaed', jackSecondaryColor: '#dbe5fd' });
